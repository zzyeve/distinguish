    ...
    public int[] setRegion(boolean islandscape, KernalLSCXMLInformation wlci, int selectedTemplateTypePosition, Camera.Size size) {
        ...
        if (islandscape) {
            ...
            regionPos[0] = (int) (wlci.fieldType
                    ...
                    .get(Constant.fieldsPosition).leftPointX * size.width);
            regionPos[1] = (int) (wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).leftPointY * size.height);
            regionPos[2] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).leftPointX + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).width) * size.width);
            regionPos[3] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).leftPointY + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).height) * size.height);
        } else {
            regionPos[0] = (int) (wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).leftPointX * size.height);
            regionPos[1] = (int) (wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).leftPointY * size.width);
            regionPos[2] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).leftPointX + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).width) * size.height);
            regionPos[3] = (int) ((wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).leftPointY + wlci.fieldType
                    .get(wlci.template.get(selectedTemplateTypePosition).templateType)
                    .get(Constant.fieldsPosition).height) * size.width);
        }
        for (int i = 0; i < regionPos.length; i++) {
            Log.d("1111", regionPos[i] + "");
        }
        return regionPos;
    }
    ...
    public VINRecogResult startOcr(VINRecogParameter vinRecogParameter) {
        ...
        if (vinRecogParameter.isFirstProgram) {
            ...
            recogBinder
                    .SetCurrentTemplate(vinRecogParameter.wlci.fieldType
                            ...
                            .get(Constant.fieldsPosition).ocrId);
            position = Constant.fieldsPosition;
        ...
        if (vinRecogParameter.isTakePic) {
            ...
            if (Imagepath != null && !"".equals(Imagepath)) {
                ...
                recogBinder.Recognize(Constant.devcode, Constant.importTempalgeID);
...
//                        + ":" + recogResultString;
        ...
        // 开始识别
        returnResult = recogBinder.Recognize(Constant.devcode,
                        vinRecogParameter.wlci.fieldType.get(vinRecogParameter.wlci.template.get(vinRecogParameter.selectedTemplateTypePosition)
                                .templateType).get(Constant.fieldsPosition).ocrId);

        Log.i("string", "模板为:" + vinRecogParameter.wlci.fieldType
                .get(vinRecogParameter.wlci.template.get(vinRecogParameter.selectedTemplateTypePosition)
                        .templateType).get(Constant.fieldsPosition).ocrId);
