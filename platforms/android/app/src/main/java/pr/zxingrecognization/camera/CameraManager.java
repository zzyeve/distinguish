...
package pr.zxingrecognization.camera;
...
public final class CameraManager {
    ...
    public Camera close() {
        if (camera != null) {
            ...
            camera.release();
            camera = null;
            Log.d("close","camera = null"+(camera==null));
        }
        Log.d("close","close"+(camera==null));
        return camera;
    }
